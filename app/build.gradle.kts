...
dependencies {
    ...
    // Compose
    implementation(enforcedPlatform("androidx.compose:compose-bom:2024.02.02"))
    androidTestImplementation(enforcedPlatform("androidx.compose:compose-bom:2024.02.02"))
