...
class GetWeatherFromLocationUseCaseTest {
    ...
    @Test
    fun `Location repo returns success, network returns error, correct error type returned`() = runTest {
    ...
    @Test
    fun `Location repo returns success, network returns empty body, correct error type returned`() = runTest {
    ...
    @Test
    fun `Location repo returns success, network returns success, correct error type returned`() = runTest {
